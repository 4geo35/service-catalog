...
class ServicePolicy implements PolicyPermissionInterface
{
    const PERMISSION_KEY = "services";
    const VIEW_ALL = 2;
    const CREATE = 4;
    const UPDATE = 8;
    const DELETE = 16;
    ...
    public function update(User $user, ServiceInterface $service): bool
    {
        return PermissionActions::allowedAction($user, self::PERMISSION_KEY, self::UPDATE);
    }

    public function delete(User $user, ServiceInterface $service): bool
    {
